# NOTEBOOKLM PROMPT TẠO SLIDE BÀI GIẢNG - Bài 4 - Nhiệt dung riêng
> **HƯỚNG DẪN:** Hãy sao chép toàn bộ nội dung dưới đây và dán trực tiếp vào khung chat của Google NotebookLM sau khi đã tải các tệp tài liệu nguồn (`bai4_nhiet_dung_rieng_dac_ta_gems.md`, `bai4_nhiet_dung_rieng_ke_hoach_bai_day.md`, `bai4_nhiet_dung_rieng_phieu_hoc_tap.md`, `bai4_nhiet_dung_rieng_huong_dan_slide.md`) làm sources.
...
1. **Yêu cầu nội dung & Đặt tên Slide dễ hiểu:**
   - Tạo cấu trúc slide chi tiết khớp hoàn toàn 1-1 với tệp `bai4_nhiet_dung_rieng_huong_dan_slide.md`.

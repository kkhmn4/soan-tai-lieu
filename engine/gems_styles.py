...
def set_cell_margins(cell, top=50, bottom=50, left=100, right=100):
    """Padding inside a table cell (in dxa = 1/20 pt)."""
...
def add_student_info_block(doc, lesson_label):
    """
    Top-of-worksheet block: lesson title + name / class / date fields.
    Returns the created table for possible further manipulation.
    """
    # Main title
    add_heading(doc, lesson_label, level=1)

    # Info row (3 cells, borderless)
